        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4 w-40">
              {/* TikTok */}
              <a href="https://www.tiktok.com/@jarahermel?is_from_webapp=1&sender_device=pc" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center bg-gray-800 rounded transition-colors h-12 w-12 text-gray-400 hover:text-white" aria-label="TikTok">
