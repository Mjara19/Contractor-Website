      ...
      <div className="bg-white min-h-screen">
        <div className="max-w-3xl mx-auto px-4 py-16">
          ...
          <p className="mb-6 text-gray-700">
            Welcome to <span className="font-bold">HMD Construction Group, LLC!</span> These Terms of Service ("Terms") govern your access to and use of our website, located at <span className="font-bold">hmdnj.com</span> including any content, functionality, and services offered on or through the website (collectively, the "Service").
          </p>
          ...
          <p className="mb-6 text-gray-700">The Service and its original content, features, and functionality are owned by HMD Construction Group and are protected by copyright, trademark, and other intellectual property laws. You may not reproduce, distribute, modify, or create derivative works of any part of the Service without our prior written consent.</p>
          ...
          <p className="mb-8 text-gray-700">If you have any questions about these Terms, please contact us at <a href="mailto:admin@hmdnj.com" className="font-bold text-red-700 hover:underline">admin@hmdnj.com</a>.</p>
